...
# Ejemplo Uso:
detalles_prestamo = 50000 + 2.69j # Real = Entrada | Imaginaria = Interés
años = 15
precio_vivienda = 180_000

loan_simulator = LoanSimulator(detalles_prestamo, años, precio_vivienda)
